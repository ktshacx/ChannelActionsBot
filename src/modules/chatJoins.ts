...
composer.on("chat_join_request", async (ctx) => {
  ...
  const def_welcome_approve =
    "Hey {name}, your request to join {chat} has been approved! Please join @ktstricks for more.";
  const def_welcome_decline =
    "Hey {name}, your request to join {chat} has been declined! Please join @ktstricks for more.";
